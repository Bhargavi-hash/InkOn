...
*/
                                                ...
                                                final Runnable       onComplete)
    {
        ...
        try
        {
            ...
            url = new URL (Environment.getQuollWriterWebsite () + "/" + Utils.replaceString (UserProperties.get (inkon.Constants.QUOLL_WRITER_LANGUAGE_FILES_URL_PROPERTY_NAME),
                                                                                                   "[[LANG]]",
...
*/
    ...
    public static Path getDictionariesDirPath ()
    {
        ...
        return Environment.getUserPath (inkon.Constants.DICTIONARIES_DIR);
    ...
    public static Path getUserDictionaryFilePath ()
    {
        ...
        return Environment.getUserPath (inkon.Constants.USER_DICTIONARY_FILE_NAME);
    ...
    public static boolean hasSynonymsDirectory (String lang)
    {
        ...
        Path f = Environment.getUserPath (inkon.Constants.THESAURUS_DIR).resolve (lang);
