...
import inkon.uistrings.*;
import inkon.text.rules.*;
import inkon.importer.*;
import inkon.ui.fx.*;
...
*/
    ...
    private static Map<String, inkon.ui.UserPropertyHandler> userPropertyHandlers = new HashMap<> ();
                                      ...
                                      java.awt.event.ActionListener onDelete)
    {
        ...
        Environment.deleteProject (p,
                                   () ->
                                   {
                                       ...
                                       inkon.ui.UIUtils.doLater (onDelete);
                                             ...
                                             final java.awt.event.ActionListener      onComplete)
    {
        ...
        Environment.sendMessageToSupport (type,
                                          ...
                                          () ->
                                          {
                                              ...
                                              inkon.ui.fx.swing.SwingUIUtils.doLater (onComplete);
...
// TODO If this needed?
    ...
    public static inkon.ui.UserPropertyHandler getUserPropertyHandler (String userProp)
    {
    ...
    @Deprecated
    public static Set<inkon.ui.BackgroundImage> getBackgroundImages ()
                                                            throws Exception
    {

        Set<inkon.ui.BackgroundImage> ret = new LinkedHashSet<> ();
        ...
        for (String s : bgImages)
        {
            ...
            ret.add (new inkon.ui.BackgroundImage (s));
...
*/
    ...
    public static KeyCombination getNewObjectTypeKeyCombination (String objType)
    {
        ...
        // TODO, make nicer.
        if (objType.equals (inkon.data.Scene.OBJECT_TYPE))
        {
