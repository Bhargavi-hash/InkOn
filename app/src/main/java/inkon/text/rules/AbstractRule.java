...
// TODO import inkon.ui.fx.components.Form;
...
public abstract class AbstractRule<E extends TextBlock> implements Rule<E>
{
    ...
    public abstract Set<inkon.ui.forms.FormItem> getFormItems ();
    ...
    public inkon.ui.forms.Form getEditForm (final java.awt.event.ActionListener        onSaveComplete,
                             ...
                             final boolean               add)
    {
        ...
        Map<inkon.ui.forms.Form.Button, java.awt.event.ActionListener> buttons = new LinkedHashMap<> ();

        buttons.put (inkon.ui.forms.Form.Button.save,
                     new java.awt.event.ActionListener ()
                     {
                        ...
                        public void actionPerformed (java.awt.event.ActionEvent ev)
                        {
                            ...
                            inkon.ui.forms.Form f = (inkon.ui.forms.Form) ev.getSource ();
        ...
        buttons.put (inkon.ui.forms.Form.Button.cancel,
                     new java.awt.event.ActionListener ()
                     {
        ...
        inkon.ui.forms.Form f = new inkon.ui.forms.Form (inkon.ui.forms.Form.Layout.stacked,
                           items,
                           buttons);
