...
import inkon.text.rules.WordFinder;
import inkon.text.rules.RuleFactory;
import inkon.text.rules.ParagraphRule;
import inkon.text.rules.SentenceRule;
...
*/
    ...
    private Node createWordsPanel ()
    {
        ...
        try
        {
            ...
            q.parse ("SELECT * FROM inkon.text.rules.WordFinder ORDER BY word.toLowerCase");
