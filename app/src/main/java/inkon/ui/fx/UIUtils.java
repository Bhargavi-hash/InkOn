...
import inkon.data.ChapterCounts;
import inkon.data.ReadabilityIndices;
import inkon.data.Prompt;
import inkon.data.ObjectReference;
import inkon.data.Project;
import inkon.data.ProjectInfo;
import inkon.data.Chapter;
import inkon.data.UserConfigurableObject;
import inkon.data.IPropertyBinder;
import inkon.data.Tag;
import inkon.data.NamedObject;
import inkon.data.UserConfigurableObjectType;
import inkon.data.Note;
import inkon.data.BlankNamedObject;
import inkon.data.Book;
import inkon.data.ChapterItem;
import inkon.data.Asset;
import inkon.data.NamedObjectNameWrapper;
import inkon.ui.fx.viewers.*;
import inkon.ui.fx.sidebars.*;
import inkon.ui.fx.components.*;
import inkon.ui.fx.popups.*;
import inkon.editors.*;
import inkon.editors.messages.*;
import inkon.uistrings.UILanguageStrings;
import inkon.uistrings.UILanguageStringsManager;
import inkon.uistrings.WebsiteLanguageStrings;
import inkon.uistrings.WebsiteLanguageStringsManager;

import static inkon.uistrings.UILanguageStringsManager.getUILanguageStringProperty;
import static inkon.uistrings.UILanguageStringsManager.getUIString;
                                             ...
                                             Set<NamedObject> exclude)
    {
        ...
        root.getChildren ().addAll (items.stream ()
            ...
            .map (chi ->
            {
                ...
                if (chi instanceof inkon.data.Scene)
                {

                    inkon.data.Scene s = (inkon.data.Scene) chi;
