...
import inkon.StringWithMarkup;
import inkon.UserProperties;
import inkon.synonyms.*;
import inkon.data.*;
import inkon.data.comparators.*;
import inkon.Constants;
import inkon.LanguageStrings;
import inkon.Environment;
import inkon.GeneralException;
import inkon.DictionaryProvider2;
import inkon.Utils;
import inkon.ui.fx.*;
import inkon.ui.fx.viewers.*;
import inkon.ui.fx.components.*;
import inkon.ui.fx.popups.*;
import inkon.text.TextIterator;
...
*/
    ...
    public Node getMarginNodeForChapterItem (ChapterItem ci)
    {
        ...
        if ((ci instanceof inkon.data.Scene)
            ||
           ...
           )
        {
            ...
            IconBox riv = IconBox.builder ()
                .iconName (((ci instanceof inkon.data.Scene) ? StyleClassNames.SCENE : StyleClassNames.OUTLINEITEM))
                .build ();
    ...
    public Set<MenuItem> getMarginContextMenuItems (int cpos)
    {
        ...
        items.add (QuollMenuItem.builder ()
            .label (getUILanguageStringProperty (Utils.newList (prefix,inkon.data.Scene.OBJECT_TYPE)))
        ...
        items.add (QuollMenuItem.builder ()
            .label (getUILanguageStringProperty (Utils.newList (prefix,inkon.data.OutlineItem.OBJECT_TYPE)))
        ...
        items.add (QuollMenuItem.builder ()
            .label (getUILanguageStringProperty (Utils.newList (prefix,inkon.data.Note.OBJECT_TYPE)))
    ...
    public void createTextPosition (ChapterItem ci)
    {
        ...
        if (ci instanceof inkon.data.Scene)
        {
            ...
            inkon.data.Scene s = (inkon.data.Scene) ci;
            s.getOutlineItems ().stream ()
                .forEach (o -> this.createTextPosition (o));
        ...
        its.add (QuollMenuButton.builder ()
            ...
            .items (() ->
            {
                ...
                */
                ...
                items.add (QuollMenuItem.builder ()
                    .label (getUILanguageStringProperty (Utils.newList (mprefix, inkon.data.Scene.OBJECT_TYPE,text)))
                    .iconName (inkon.data.Scene.OBJECT_TYPE)
                    //.tooltip (new SimpleStringProperty (pref + "S"))
                    .accelerator (Environment.getNewObjectTypeKeyCombination (inkon.data.Scene.OBJECT_TYPE))
                    .onAction (eev ->
                    {
...
*/
                          ...
                          Node        showAt)
    {
        ...
        if ((item instanceof inkon.data.Scene)
            ||
    ...
    public void showAddNewScene (int pos)
    {
        ...
        inkon.data.Scene s = new inkon.data.Scene ();
        s.setPosition (pos);
                                ...
                                boolean editNeeded)
    {
        ...
        inkon.data.Note item = new inkon.data.Note ();
...
*/
                                                          ...
                                                          String desc)
    {
        ...
        buts.add (QuollButton.builder ()
            .tooltip (getUILanguageStringProperty (Utils.newList (prefix,inkon.data.Scene.OBJECT_TYPE,tooltip)))
            .iconName (StyleClassNames.SCENE)
            .onAction (ev ->
            {
