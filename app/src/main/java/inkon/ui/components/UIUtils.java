...
public class UIUtils
{
    ...
    public static final DropShadowBorderX internalPanelDropShadow = new DropShadowBorderX (inkon.ui.UIUtils.getColor ("#cccccc"),
                                                                                           1,
                                                                                           8);

    public static final DropShadowBorderX popupPanelDropShadow = new DropShadowBorderX (inkon.ui.UIUtils.getColor ("#cccccc"), //UIManager.getColor ("Control"),
                                                                                        1,
                                                                                        12);
