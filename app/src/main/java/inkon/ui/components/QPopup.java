...
import inkon.ui.PopupsSupported;
...
public class QPopup extends Box
{
    ...
    public static Border defaultBorder = new CompoundBorder (UIUtils.popupPanelDropShadow,
                                                             new MatteBorder (1,
                                                                              ...
                                                                              1,
                                                                              1,
                                                                              inkon.ui.UIUtils.getBorderColor ()));
                  ...
                  Component controls)
    {
        ...
        this.header.setFont (this.header.getFont ().deriveFont ((float) inkon.ui.UIUtils.getScaledFontSize (14)).deriveFont (Font.PLAIN));
        this.header.setTitleColor (inkon.ui.UIUtils.getTitleColor ());
    ...
    public QPopup(Header h)
    {
        ...
        this.box.setBackground (inkon.ui.UIUtils.getComponentColor ());
    ...
    public void resize ()
    {
        ...
        c.validate ();
        c.setPreferredSize (new Dimension (inkon.ui.UIUtils.getPopupWidth (),
