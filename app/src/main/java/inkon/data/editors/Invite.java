...
public class Invite
{
                              ...
                              throws Exception
    {
        ...
        inv.setFromPublicKey (EditorsUtils.convertToPGPPublicKey (inkon.Base64.decode ((String) m.get ("fromPublicKey"))));
        inv.setToPublicKey (EditorsUtils.convertToPGPPublicKey (inkon.Base64.decode ((String) m.get ("toPublicKey"))));
