...
/*
TODO Remove
    public ObjectNameUserConfigurableObjectFieldViewEditHandler getPrimaryNameViewEditHandler (inkon.ui.ProjectViewer viewer)
    {
...
/*
TODO Remove
    public ObjectDescriptionUserConfigurableObjectFieldViewEditHandler getObjectDescriptionViewEditHandler (inkon.ui.ProjectViewer viewer)
    {
...
*/
    ...
    public Set<inkon.ui.userobjects.UserConfigurableObjectFieldViewEditHandler> getViewEditHandlers (inkon.ui.ProjectViewer viewer)
    {
        ...
        Set<inkon.ui.userobjects.UserConfigurableObjectFieldViewEditHandler> handlers = new LinkedHashSet<> ();
        ...
        for (UserConfigurableObjectTypeField tf : this.userConfigObjType.getConfigurableFields ())
        {
            ...
            inkon.ui.userobjects.UserConfigurableObjectFieldViewEditHandler h = tf.getViewEditHandler (this,
                                                                                  f,
                                                                                  viewer);
